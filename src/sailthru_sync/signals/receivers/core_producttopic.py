...
@receiver(m2m_changed, sender=core_models.Product.topics.through, dispatch_uid='sailthru_sync::signals::producttopic_m2m_changed')
def producttopic_m2m_changed(sender, **kwargs):
    ...
    if action in valid_actions:
        if reverse:
            product_actions = (
                core_models.ProductAction.objects
                .filter(
