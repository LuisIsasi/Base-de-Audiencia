...
athena_content_metadata_router.register('athena-content-metadata', api_views.AthenaContentMetadataViewSet)

user_content_history_router = nested_routers.SimpleRouter(trailing_slash=False)
user_content_history_router.register('user-content-history', api_views.UserContentHistoryViewSet)
