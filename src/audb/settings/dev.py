...
RAVEN_CONFIG['dsn'] = 'http://5b35e023668542a19ea102f986a70a3d:9292b78557e24dcb8352a13f5d6ecdaa@sentry01.geprod.amc/17'
...
LOGGING['handlers']['sailthru_sync.tasks']['filename'] = '/data/local/log/sailthru_sync/tasks.log'
